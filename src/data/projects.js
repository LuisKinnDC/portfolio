...
export const proyectos = [
  ...
  {
    id: 3,
    titulo: "Portafolio personal optimizado",
    descripcion:
      "Sitio web personal con diseño moderno, rendimiento excepcional y animaciones fluidas para destacar proyectos y habilidades.",
    problema: "Necesidad de un portafolio digital profesional y optimizado.",
    solucion: "Sitio web personal con diseño moderno, rendimiento excepcional y animaciones fluidas.",
    imagen: "/PortafolioPersonal.png",
    tecnologias: ["React", "Tailwind CSS", "Framer Motion", "Vite", "Three.js"],
    categoria: "web",
    github: "https://github.com/LuisKinnDC/portfolio",
    demo: "https://portfolio-luiskinndc.vercel.app/#inicio",
    aiAugmented: true,
  },
  {
    id: 4,
